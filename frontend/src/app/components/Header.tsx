...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full px-6 py-4 bg-zinc-100 shadow-md flex flex-wrap items-center justify-between">
      ...
      <nav
        className={`${isOpen ? 'flex' : 'hidden sm:flex'
                  ...
                  w-50 sm:w-auto bg-gray-100 sm:bg-transparent shadow-lg sm:shadow-none
